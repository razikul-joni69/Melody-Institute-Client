...
import useSidebarToggle from "../../hooks/useSidebarToggle.js";
import {GrClose} from "react-icons/gr";
import {AiOutlineMenuUnfold} from "react-icons/ai";
import {CgClose} from "react-icons/cg";

const StudentsDashboard = () => {
    // const [sidebarVisible, toggleSidebar] = useSidebarToggle()
    ...
    return (
        <div>
            <button onClick={toggleSidebar}>{sidebarVisible ? <CgClose className={`h-6 w-6` }/> : <AiOutlineMenuUnfold className={`h-6 w-6`}/>} </button>
