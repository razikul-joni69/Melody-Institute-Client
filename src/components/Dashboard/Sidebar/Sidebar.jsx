            ...
            <div className="dark:bg-[#1f2937] md:flex">
                <Slide>
                    <div
                        ...
                        } w-full  p-3 space-y-2 md:w-60 bg-gray-50 text-gray-800 dark:bg-[#111827] dark:text-white`}
                    >
                        ...
                        <div className="divide-y divide-gray-300">
                            ...
                            <ul className="pt-4 pb-2 space-y-1 text-sm">
                                <li>
                                    <NavLink
                                        to="/user/profile"
                                        className="flex items-center w-full p-2 space-x-3 rounded-md btn-ghost"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512"
                                            className="w-5 h-5 text-gray-600 fill-current dark:text-white"
                                        >
